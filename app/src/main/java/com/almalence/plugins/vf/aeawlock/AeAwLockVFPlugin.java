...
public class AeAwLockVFPlugin extends PluginViewfinder {
    ...
    private RotateImageView aeLockButton;
    private RotateImageView awLockButton;

    private View buttonsLayout;

    private boolean showAEAWLock;

    private boolean aeLocked = false;
    private boolean awLocked = false;
    ...
    private void refreshPreferences() {
        ...
        aeLocked = false;
        awLocked = false;
        prefs.edit().putBoolean(ApplicationScreen.sAWBLockPref, aeLocked).apply();
        prefs.edit().putBoolean(ApplicationScreen.sAWBLockPref, awLocked).apply();
    ...
    public void onGUICreate() {
        ...
        if (showAEAWLock) {
            ...
            aeLockButton = buttonsLayout.findViewById(R.id.buttonAELock);
            awLockButton = buttonsLayout.findViewById(R.id.buttonAWLock);
        ...
        if (showAEAWLock && ((aeLockButton != null && aeLockButton.getVisibility() == View.VISIBLE) || (awLockButton != null && awLockButton.getVisibility() == View.VISIBLE))) {
            RotateImageView expandManualControls = ApplicationScreen.instance.findViewById(R.id.expandManualControls);
    ...
    private void AeLock() {
        if (CameraController.isExposureLockSupported()) {
            ...
            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(ApplicationScreen.getMainContext());
            prefs.edit().putBoolean(ApplicationScreen.sAELockPref, aeLocked).apply();
        }
    }
